...
public:
  LinearApproximator();
  LinearApproximator(const Eigen::VectorXd& bias, const Eigen::MatrixXd& coeffs);
  ...
  LinearApproximator(int input_dim, int output_dim, const Eigen::VectorXd& parameters);
  ...
  LinearApproximator(int input_dim, int output_dim, const Eigen::VectorXd& parameters, const Eigen::VectorXd& center);
  ...
  static Eigen::MatrixXd getParametersSpace(const Eigen::MatrixXd& input_limits, const Eigen::MatrixXd& output_limits,
                                            bool narrow_slope);
